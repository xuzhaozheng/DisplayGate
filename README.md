...
The status item uses the `display.2` SF Symbol as an interface icon. The application icon under `Assets/` is an original geometric drawing generated by `Tools/make_displaygate_icon.swift`.
